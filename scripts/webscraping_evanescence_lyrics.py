# Inputs - for any other artist replace url and path_csv

# urls where to find hyperlinks for lyrics
...
# path where to keep the .csv file with the obtained title of lyrics and lyrics 
...
def extract_lyric_from_url(url_lyric):
    ...
    soup_lyric = BeautifulSoup(html_doc_lyric,features ="lxml")
